...
export class ResultsScene extends Phaser.Scene {
  ...
  public create() {
    ...
    let bgKey = 'bg_location_joburg';
    if (this.textures.exists('bg_location_joburg')) {
      bgKey = 'bg_location_joburg';
    } else if (this.textures.exists('bg_location_hanover_park')) {
      bgKey = 'bg_location_hanover_park';
